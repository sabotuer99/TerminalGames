...
public class LinuxKeyboardEventDriver implements KeyboardEventDriver{	
	
	private final static Logger logger = LogManager.getLogger(LinuxKeyboardEventDriver.class);
	...
	private LinuxKeyboardEventDriver(){}
	...
	public static class Builder{
		...
		public LinuxKeyboardEventDriver build(){
			LinuxKeyboardEventDriver instance = new LinuxKeyboardEventDriver();
			instance.in = this.in;
