...
public class PlayerStrings {
	...
	public static final String WALK_LEFT   = " (ಠ_ಠˏ)";  //left
	public static final String WALK_UP     = "ˏ(ఠ_ఠ)ˎ";  //up
	public static final String WALK_DOWN   = "`(ఠ_ఠ)´";  //down
	public static final String STAND_STILL = "ˎ(ಠ_ಠ)ˏ";  //up
}
